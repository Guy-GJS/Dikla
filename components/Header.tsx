            ...
            <form onSubmit={handleSearch} className="hidden md:flex items-center flex-1 justify-center max-w-xl mx-8">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full pr-4 pl-10 py-2.5 bg-white border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none text-sm transition-all"
                />
                <button
                  type="submit"
                  className="absolute left-2 top-1/2 -translate-y-1/2 p-1.5 text-gray-500 hover:text-blue-600 transition-colors"
                >
            ...
            <div className="container mx-auto px-4 py-4 space-y-4">
              ...
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  onChange={(e) => setKeyword(e.target.value)}
                  placeholder="חיפוש פריט"
                  className="w-full pr-4 pl-10 py-3 bg-white border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none text-sm"
                />
                <button
                  type="submit"
                  className="absolute left-2 top-1/2 -translate-y-1/2 p-1.5 text-gray-500 hover:text-blue-600 transition-colors"
